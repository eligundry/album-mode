...
import { Container, Heading, Typography } from '~/components/Base'
      ...
      {user && (
        <>
          ...
          <Typography variant="hint">
            These settings allow Album Mode.party to improve the quality of your
            Spotify recommendations as you use the application.
          </Typography>
