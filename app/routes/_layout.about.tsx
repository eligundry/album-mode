...
import { A, Container, Heading, Link, Typography } from '~/components/Base'
    ...
    <Container>
      <div className={clsx('prose', 'dark:prose-invert')}>
        ...
        <Typography>
          ...
          you aren't interested in? Are you just so tired of hunting for new
          music that you fallback on a reliable favorite? Wouldn't it be nice if
          you were presented a single album and just listened to it, just like
          back in the days of record stores?
        </Typography>
        <Typography>
          ...
          recommend to me. Spotify thinks I want more of what I listen to, but,
          in reality, I want music recommendations that I don't know that I'd
          want or even like.
        </Typography>
        <Typography>
        ...
        <Typography>
          ...
          token to your cookies locally and will sync the albums that you like
          to the Cloud™️. I do this so that you can sync saved albums across
          devices and doing this peer to peer is way harder than it should be.
        </Typography>
        <Typography>
          <strong>
        ...
        <Typography>
          Thanks to{' '}
          <A href="https://www.linkedin.com/in/paul-decotiis/">Paul DeCotiis</A>{' '}
        ...
        <Typography>
          ...
          this site. Their names and lists are owned by them and used under fair
          use. I absolutely love all the publications listed and I hope that is
